...
namespace Unity.MLAgentsExamples
{
    ...
    public class BodyPart
    {
        ...
        // public AgentContact agentContact; // TestPart
        ...
        public void Reset(BodyPart bp)
        {
            ...
            /*if (bp.agentContact)
            {
                bp.agentContact.touchingAgent = false;
            }*/
    ...
    public class JointDriveController : MonoBehaviour
    {
        ...
        public void SetupBodyPart(Transform t)
        {
            ...
            // TestPart, Add & setup the Agent contact script
            /*bp.agentContact = t.GetComponent<AgentContact>();
            if (!bp.agentContact)
            {
                bp.agentContact = t.gameObject.AddComponent<AgentContact>();
                bp.agentContact.agent = gameObject.GetComponent<Agent>();
            }
            else
            {
                bp.agentContact.agent = gameObject.GetComponent<Agent>();
